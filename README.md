...
End-to-end product analytics on a public dataset: funnels, retention cohorts, engagement segmentation, and a north-star metric proposal. SQL-first, with Spark SQL for scale.
